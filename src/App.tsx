  ...
  return (
    <article className="trace-panel">
      <header className="trace-panel__bar">
        ...
        <div className="trace-panel__meta">{checkpoints.length ? <span>{checkpoints.length} checkpoints</span> : null}{breakIndex >= 0 ? <span className="trace-panel__flag"><i aria-hidden="true" />{reconciliationCase?.amounts_known ? "1 divergence" : "Evidence gap"}</span> : null}</div>
      </header>
